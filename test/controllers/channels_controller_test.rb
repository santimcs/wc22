...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { logo: @channel.logo, name: @channel.name, number: @channel.number, url: @channel.url } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { logo: @channel.logo, name: @channel.name, number: @channel.number, url: @channel.url } }
