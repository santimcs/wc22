...
*Edit app/views/teams/show.html*

	<%= image_tag @team.flag %>

*Edit app/views/teams/index.html*
...
*Edit app/views/fixtures/index.html*
...
*Edit app/assets/stylesheets/application.css.scss to increase space between menu and content*
