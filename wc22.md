...
## Bootsrap  
*Edit home.html.erb to check that bootstrap is included or not*   
...
*Edit views/teams/show.html*

	<%= image_tag @team.flag %>

*Edit views/teams/index.html*
...
*Edit db/migrate/create_fixtures.rb*
...
*Edit views/fixtures/_form.html.erb*
...
*Edit views/fixtures/index.html.erb*
...
*Edit controllers/fixtures_controller.rb*
...
*Edit application.css to increase space between menu and content*
